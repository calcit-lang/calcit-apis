                    ...
                    :data $ {}
                      ...
                      |j $ {}
                        :data $ {}
                          ...
                          |j $ {}
                            :data $ {}
                              |T $ {} (:type :leaf) (:by |rJG4IHzWf) (:at 1629457503664) (:text |slurp-cirru-edn)
                        ...
                        :data $ {}
                          ...
                          |j $ {}
                            :data $ {}
                              ...
                              |j $ {}
                                :data $ {}
                                  |T $ {} (:type :leaf) (:by |rJG4IHzWf) (:at 1629457527022) (:text |parse-cirru-edn)
                                  |j $ {}
                                    :data $ {}
                                      |T $ {} (:type :leaf) (:by |rJG4IHzWf) (:at 1629457527022) (:text |slurp-cirru-edn)
